  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles["input-group"]}>
        ...
        <input type="number" id="rate" value={rate} onChange={setCustomRate} />
      </div>
      ...
      {tableData.length > 0 && (
        <div className={styles["table-container"]}>
          <div className="my-2">
            <label className="mx-2">Final Amount</label>
            <span className="text-white">{lastAmountTitle}</span>
          </div>
          <table>
            <thead>
              <tr>
                ...
                <th>Amount</th>
                <th>
                  After Interest (<small>{paidInterest}</small>)
                </th>
              </tr>
            </thead>
            <tbody>
