...
function StockAverage() {
  ...
  const calculateInvestments = (e) => {
    ...
    const totalInvestment =
      parseFloat(initialInvestment) + parseFloat(newInvestment);
    ...
    <div className="flex-col items-center m-3 px-3 ">
      <form onSubmit={calculateInvestments}>
        ...
        <div className="my-2">
          ...
          {initialInvestment && (
            <div>Initial Invested Amount: {initialInvestment}</div>
          )}
        </div>
        <hr />
        <div className="my-2">
